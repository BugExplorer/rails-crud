...
RSpec.describe PostsController, type: :controller do
  describe "GET #index" do
    ...
    it "populates an array of posts" do
      first_post  = FactoryGirl.create(:post, author_name: 'Smith')
      second_post = FactoryGirl.create(:post, author_name: 'Jones')
      get :index
  ...
  describe "PATCH #update" do
    ...
    context "valid attributes" do
      ...
      it "changes @post's attributes" do
        ...
        expect(@post.content).to eq('Another content')
      end
    ...
    context "with invalid attributes" do
      it "does not change the @post's attributes" do
        ...
        @post.reload
        expect(@post.title).to_not eq('Update')
        expect(@post.content).to eq('Rails')
      end
